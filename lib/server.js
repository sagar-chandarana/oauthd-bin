...
server.get(config.base + '/auth/:provider', function(req, res, next) {
  ...
  return async.waterfall([
    function(cb) {
      ...
      if (response_type !== 'token' && (!options.state || options.state_type)) {
...
server.post(config.base_api + '/apps', auth.needed, function(req, res, next) {
...
server.get(config.base_api + '/apps/:key', auth.needed, function(req, res, next) {
...
server.post(config.base_api + '/apps/:key', auth.needed, function(req, res, next) {
  return db.apps.update(req.params.key, req.body, send(res, next));
});

server.del(config.base_api + '/apps/:key', auth.needed, function(req, res, next) {
...
server.post(config.base_api + '/apps/:key/reset', auth.needed, function(req, res, next) {
  return db.apps.resetKey(req.params.key, send(res, next));
});

server.get(config.base_api + '/apps/:key/domains', auth.needed, function(req, res, next) {
  return db.apps.getDomains(req.params.key, send(res, next));
});

server.post(config.base_api + '/apps/:key/domains', auth.needed, function(req, res, next) {
  return db.apps.updateDomains(req.params.key, req.body.domains, send(res, next));
});

server.post(config.base_api + '/apps/:key/domains/:domain', auth.needed, function(req, res, next) {
  return db.apps.addDomain(req.params.key, req.params.domain, send(res, next));
});

server.del(config.base_api + '/apps/:key/domains/:domain', auth.needed, function(req, res, next) {
  return db.apps.remDomain(req.params.key, req.params.domain, send(res, next));
});

server.get(config.base_api + '/apps/:key/keysets', auth.needed, function(req, res, next) {
  return db.apps.getKeysets(req.params.key, send(res, next));
});

server.get(config.base_api + '/apps/:key/keysets/:provider', auth.needed, function(req, res, next) {
  return db.apps.getKeyset(req.params.key, req.params.provider, send(res, next));
});

server.post(config.base_api + '/apps/:key/keysets/:provider', auth.needed, function(req, res, next) {
  return db.apps.addKeyset(req.params.key, req.params.provider, req.body, send(res, next));
});

server.del(config.base_api + '/apps/:key/keysets/:provider', auth.needed, function(req, res, next) {
  return db.apps.remKeyset(req.params.key, req.params.provider, send(res, next));
});

server.get(config.base_api + '/providers', auth.needed, function(req, res, next) {
